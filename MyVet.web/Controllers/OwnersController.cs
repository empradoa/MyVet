...
namespace MyVet.web.Controllers
{
    ...
    {       
        ...
        // GET: Trae los datos de Owners de la bd
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var owner = await _dataContext.Owners
                .Include(o => o.User)
                .Include(o => o.Pets)
                .ThenInclude(p => p.PetType) //Relacionar otra tabla de segundo orden
                .Include(o => o.Pets)
        ...
        // GET: metodo para eliminar usuario de la BD
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            //invocamos el metodo deleteuserAsync del _usarHelper para eliminar el usuario (owner)
