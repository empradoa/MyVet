...
namespace MyVet.Prism.ViewModels
{
    public class ProfilePageViewModel : ViewModelBase
    {
        ...
        private async Task<bool> ValidateData()
        {
            ...
            {
                await App.Current.MainPage.DisplayAlert(
                    "Error", "you must enter a document.", "Accept");
                return false;
            }
            ...
            {
                await App.Current.MainPage.DisplayAlert(
                    "Error", "you must enter a firstname.", "Accept");
                return false;
            }
            ...
            {
                await App.Current.MainPage.DisplayAlert(
                    "Error", "you must enter a lastname.", "Accept");
                return false;
            }
            ...
            {
                await App.Current.MainPage.DisplayAlert(
                    "Error", "you must enter a address.", "Accept");
                return false;
            }
