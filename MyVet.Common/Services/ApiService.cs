...
namespace MyVet.Common.Services
{
    public class ApiService : IApiService
    {
            ...
            TokenRequest request)
        {
            try
            {
                //SerializeObject es coger un objeto y convertilo en string
                ...
                //DeserializeObject es coger un string y convertilo es clase o objeto
        ...
        //select de pet type en editar o nueva pet.
